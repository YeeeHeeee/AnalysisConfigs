...
def stitching_func(params, metadata, events, size, shape_variations):
  ...
  if metadata["year"] == "2018" and metadata["sample"] == "TTToHadronic":
    ...
    return np.select(
      ...
      choicelist=[
        np.ones(len(events)) * 0.05085534652569182,
        np.ones(len(events)),
      ],
      default=0.0
    )
    ...
    return np.select(
      ...
      choicelist=[
        np.ones(len(events)) * 0.019485654047343735,
        np.ones(len(events)),
      ],
      default=0.0
    )
    ...
    return np.select(
      ...
      choicelist=[
        np.ones(len(events)) * 0.05659606320880067,
        np.ones(len(events)),
      ],
      default=0.0
    )
    ...
    return np.select(
      ...
      choicelist=[
        np.ones(len(events)) * 0.01922077362984597,
        np.ones(len(events)),
      ],
      default=0.0
    )
    ...
    return np.select(
      ...
      choicelist=[
        np.ones(len(events)) * 0.040057424186050676,
        np.ones(len(events)),
      ],
      default=0.0
    )
    ...
    return np.select(
      ...
      choicelist=[
        np.ones(len(events)) * 0.015338036230480523,
        np.ones(len(events)),
      ],
      default=0.0
    )
    ...
    return np.select(
      ...
      choicelist=[
        np.ones(len(events)) * 0.028799588947413912,
        np.ones(len(events)),
      ],
      default=0.0
    )
    ...
    return np.select(
      ...
      choicelist=[
        np.ones(len(events)) * 0.013497770657061326,
        np.ones(len(events)),
      ],
      default=0.0
    )
